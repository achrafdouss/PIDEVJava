 ...
 * @author bouyo
 */
public class ProprietaireProduitFXMLController extends AcceulProduitFXMLController {
    ...
    private void Habillement(ActionEvent event) {
        ...
        liste = new ArrayList<>(produitservice.findAllFiltrer("Habillement et bien etre"));
    ...
    private void Immobilier(ActionEvent event) {
        ...
        liste = new ArrayList<>(produitservice.findAllFiltrer("Immobilier"));
    ...
    private void Vehicule(ActionEvent event) {
        ...
        liste = new ArrayList<>(produitservice.findAllFiltrer("Vehicule"));
    ...
    private void Informatique(ActionEvent event) {
        ...
        liste = new ArrayList<>(produitservice.findAllFiltrer("Informatique et multimédia"));
